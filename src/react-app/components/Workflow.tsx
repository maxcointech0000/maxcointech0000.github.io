...
const Workflow: React.FC = () => {
  ...
  const workflowSteps = [
    ...
    },
    {
      ...
      borderGradient: 'from-rose-500 to-red-500'
    }
  ];
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-black via-gray-900 to-gray-800 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          <div className="inline-flex flex-col items-center space-y-6 bg-gradient-to-r from-blue-500/10 via-transparent to-cyan-500/10 backdrop-blur-sm border border-white/10 rounded-3xl px-12 py-8">
            ...
            <a
              href="#contact"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-2xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
            >
