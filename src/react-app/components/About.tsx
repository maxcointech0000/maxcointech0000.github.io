...
const About: React.FC = () => {
  ...
  const stats = [
    { icon: Award, label: 'Years Experience', value: '8+', color: 'text-yellow-400' },
    { icon: Code2, label: 'Projects Completed', value: '50+', color: 'text-purple-400' },
    { icon: Globe, label: 'Global Clients', value: '30+', color: 'text-cyan-400' },
    { icon: Clock, label: 'Success Rate', value: '100%', color: 'text-green-400' }
  ];
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-800 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-32 left-20 w-64 h-64 bg-purple-500 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          {skills.map((skill, index) => (
            ...
            >
              <div className={`relative bg-gradient-to-br ${skill.bgColor} backdrop-blur-sm border border-white/10 rounded-3xl p-8 h-full hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10`}>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-purple-500/10 via-transparent to-cyan-500/10 backdrop-blur-sm border border-white/10 rounded-3xl p-12"
        >
