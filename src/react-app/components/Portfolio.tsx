...
const Portfolio: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      'Blockchain': 'from-cyan-500 to-teal-500',
      'App': 'from-green-500 to-emerald-500',
      'Chatbot': 'from-amber-500 to-orange-500',
      'Fullstack': 'from-blue-600 to-cyan-600',
    };
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredProjects.map((project) => (
              ...
              >
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10">
                  {/* Project Image */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <Link
                        ...
                        className="flex items-center space-x-2 text-blue-400 hover:text-blue-300 font-medium text-sm transition-colors"
                      >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        {project.githubUrl && (
                          <a
                            ...
                            className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors group"
                          >
                            <Github className="w-4 h-4 text-white group-hover:text-blue-400" />
                          </a>
                        )}
                      </div>
                    </div>
        ...
        >
          <div className="inline-flex items-center space-x-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-8 py-6">
            ...
            <a
              href="#contact"
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
            >
              Get In Touch
            </a>
          </div>
